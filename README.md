...
### `Server side project`
This project is generated by [LoopBack](http://loopback.io). for server side .

### `Client side project`
This project was bootstrapped with [Create Next App](https://github.com/segmentio/create-next-app). for client side .
...
# react-ecommerce
This is an eCommerce project developed using reactjs, context api, nextjs, graphQl and IBM loopback as a server side framework .. it's SEO friendly .
